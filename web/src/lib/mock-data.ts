// Client-side mirror of demo data for SSR-friendly pages without API dependency.
// When NEXT_PUBLIC_API_URL is set, the app prefers the Fastify API.
...
export const contests = [
  {
    ...
    difficulty: "Div. 2",
    ratingMin: 0 as number | null,
    ratingMax: 2099 as number | null,
    virtualAvail: true,
    participants: 28000,
    bookmarked: true,
  },
...
export function generateHeatmap(days = 365) {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    cells.push({ date, count, platforms: plats });
  }
  return cells;
}
...
export const goals = [
  { id: "g1", title: "Solve 5 problems / day", period: "DAILY", target: 5, current: 3, metric: "problems", isCompleted: false },
  { id: "g2", title: "Participate in 3 contests", period: "WEEKLY", target: 3, current: 1, metric: "contests", isCompleted: false },
  { id: "g3", title: "Reach 1800 CF rating", period: "MONTHLY", target: 1800, current: 1624, metric: "rating", isCompleted: false },
  { id: "g4", title: "Maintain 50-day streak", period: "MONTHLY", target: 50, current: 47, metric: "streak", isCompleted: false },
  { id: "g5", title: "Finish Graph roadmap", period: "MONTHLY", target: 40, current: 28, metric: "roadmap", isCompleted: false },
];
...
export const leaderboard = [
  ...friends.map((f) => ({ ...f, weeklySolved: 20 })),
  {
    id: demoUser.id,
  ...
  .sort((a, b) => b.xp - a.xp)
  .map((u, i) => ({ ...u, rank: i + 1, weeklySolved: 20 + ((i * 3) % 40) }));

export const roadmaps = [
  { slug: "arrays", title: "Arrays & Hashing", description: "Foundation of problem solving — arrays, hashing, two pointers", category: "Fundamentals", progress: 85, total: 40, completed: 34, color: "from-blue-500 to-cyan-400" },
  { slug: "strings", title: "Strings", description: "Pattern matching, KMP, Z-algorithm, string DP", category: "Fundamentals", progress: 60, total: 35, completed: 21, color: "from-violet-500 to-purple-400" },
  { slug: "linked-list", title: "Linked List", description: "Pointers, reversal, cycle detection, design problems", category: "Fundamentals", progress: 90, total: 25, completed: 22, color: "from-emerald-500 to-teal-400" },
  { slug: "stack-queue", title: "Stack & Queue", description: "Monotonic stacks, deque tricks, expression evaluation", category: "Fundamentals", progress: 70, total: 30, completed: 21, color: "from-amber-500 to-orange-400" },
  { slug: "trees", title: "Trees & BST", description: "Traversals, LCA, diameter, BST invariants, tree DP intro", category: "Intermediate", progress: 55, total: 45, completed: 25, color: "from-green-500 to-lime-400" },
  { slug: "graphs", title: "Graphs", description: "BFS/DFS, shortest paths, MSTs, SCCs, flows intro", category: "Intermediate", progress: 70, total: 50, completed: 35, color: "from-rose-500 to-pink-400" },
  { slug: "heap", title: "Heap & Priority Queue", description: "Top-K, streaming, Dijkstra companion patterns", category: "Intermediate", progress: 40, total: 20, completed: 8, color: "from-yellow-500 to-amber-400" },
  { slug: "trie", title: "Trie", description: "Prefix trees, XOR trie, autocomplete patterns", category: "Intermediate", progress: 30, total: 18, completed: 5, color: "from-indigo-500 to-blue-400" },
  { slug: "dp", title: "Dynamic Programming", description: "1D/2D DP, knapsack, LIS, digit DP, DP on trees/graphs", category: "Advanced", progress: 45, total: 60, completed: 27, color: "from-fuchsia-500 to-pink-400" },
  { slug: "greedy", title: "Greedy", description: "Exchange arguments, scheduling, constructive greedy", category: "Intermediate", progress: 50, total: 28, completed: 14, color: "from-sky-500 to-blue-400" },
  { slug: "bit", title: "Bit Manipulation", description: "Bitmasks, XOR tricks, SOS DP intro", category: "Intermediate", progress: 35, total: 22, completed: 8, color: "from-slate-500 to-zinc-400" },
  { slug: "segment-tree", title: "Segment Tree & Fenwick", description: "Range queries, lazy propagation, Fenwick trees", category: "Advanced", progress: 20, total: 30, completed: 6, color: "from-red-500 to-orange-400" },
  { slug: "binary-search", title: "Binary Search", description: "On answer, rotated arrays, predicate search", category: "Fundamentals", progress: 75, total: 25, completed: 19, color: "from-cyan-500 to-teal-400" },
  { slug: "backtracking", title: "Backtracking", description: "Subsets, permutations, constraint satisfaction", category: "Intermediate", progress: 65, total: 20, completed: 13, color: "from-purple-500 to-violet-400" },
  { slug: "geometry", title: "Computational Geometry", description: "Convex hull, line sweep, half-planes", category: "Advanced", progress: 10, total: 18, completed: 2, color: "from-teal-500 to-emerald-400" },
  { slug: "math", title: "Math & Number Theory", description: "Primes, modular arithmetic, combinatorics, CRT", category: "Advanced", progress: 40, total: 35, completed: 14, color: "from-orange-500 to-red-400" },
];
...
export const discussions = [
  { id: "d1", title: "How to approach Digit DP from scratch?", author: "dp_wizard", tags: ["DP", "Tutorial"], likes: 128, comments: 34, createdAt: new Date(now - 2 * day).toISOString() },
  { id: "d2", title: "Editorial intuition for CF 1000C", author: "graph_girl", tags: ["Codeforces", "Editorial"], likes: 86, comments: 19, createdAt: new Date(now - 1 * day).toISOString() },
  { id: "d3", title: "My 6-month journey: 1200 → 1800", author: "neethack", tags: ["Motivation", "Roadmap"], likes: 340, comments: 72, createdAt: new Date(now - 4 * day).toISOString() },
  { id: "d4", title: "Binary lifting vs LCA with Euler tour", author: "seg_tree", tags: ["Trees", "Techniques"], likes: 54, comments: 12, createdAt: new Date(now - 6 * hour).toISOString() },
];

export const notes = [
  { id: "n1", title: "Segment Tree Lazy Template", content: "```cpp\n// push / pull lazy propagation\n```\nRemember: push before recurse, pull after.", tags: ["Segment Tree", "Template"], problemTitle: "Range Updates", updatedAt: new Date(now - day).toISOString() },
  { id: "n2", title: "Binary Search on Answer checklist", content: "1. Monotonic predicate\n2. lo/hi bounds\n3. mid overflow-safe\n4. verify edge cases", tags: ["Binary Search"], problemTitle: "Koko Eating Bananas", updatedAt: new Date(now - 3 * day).toISOString() },
  { id: "n3", title: "Graph multipource BFS", content: "Push all sources with dist 0. Works for rotting oranges, walls & gates.", tags: ["Graph", "BFS"], problemTitle: "01 Matrix", updatedAt: new Date(now - 5 * day).toISOString() },
];
